...
///
/// A given [CustomSearchDelegate] can only be associated with one active [showCustomSearch]
/// call. Call [CustomSearchDelegate.close] before re-using the same delegate instance
/// for another [showCustomSearch] call.
///
...
/// Delegate for [showCustomSearch] to define the content of the search page.
///
...
/// to notify the caller of [showCustomSearch] about the selected search result.
///
/// A given [CustomSearchDelegate] can only be associated with one active [showCustomSearch]
/// call. Call [CustomSearchDelegate.close] before re-using the same delegate instance
/// for another [showCustomSearch] call.
...
abstract class CustomSearchDelegate<T> {
  ...
  /// communicate the result back to the initial caller of [showCustomSearch].
  ...
  /// to [showCustomSearch] that launched the search initially.
